...
"""
Внимание! приложение запускается с порта 8090
...
----------------------------------------------
Этот домен не указан в приложении запущенном на порте 8000, поэтому он не может выполнять ajax запросы.
"""
...
if __name__ == '__main__':
    app_run(file=__file__, app_name=app.name, host="127.0.0.1", port=8090)
